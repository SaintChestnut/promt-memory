  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
      <h1 className="head_text text-left">
        <span className="blue_gradient">{TypeMessage[type]} Post</span>
      </h1>
      <p className="desc text-left max-w-md">
        {type} your own AI-powered prompts and share them with the world, or edit existing ones to improve their
        performance.
      </p>
      <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
        <label>
          <span className="font-satoshi font-semibold taxt-base text-gray-700">Your AI Prompt</span>
          <textarea
        ...
        <label>
          <span className="font-satoshi font-semibold taxt-base text-gray-700">Tag</span>
          <input
            value={post.tag}
